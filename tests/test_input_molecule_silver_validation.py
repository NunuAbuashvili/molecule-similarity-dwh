...
class TestBuildOverridesClause:
    ...
    def test_single_override_produces_one_row_and_flat_params(
        self,
        monkeypatch
    ):
        monkeypatch.setattr(
    ...
    def test_multiple_overrides_produce_matching_rows_and_params(
        self,
        monkeypatch
    ):
        monkeypatch.setattr(
...
class TestValidateAndMatch:
    ...
    def test_logs_correct_summary_counts(
        self,
        mock_postgres_hook,
        monkeypatch,
        caplog
