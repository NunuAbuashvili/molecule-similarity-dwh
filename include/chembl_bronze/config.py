...
TABLE_CONFIGS = {
    "chembl_id_lookup": {
        ...
        "columns": ["chembl_id", "entity_type", "entity_id", "status", "last_active"],
    },
    "molecule_dictionary": {
        "target_table": "bronze.molecule_dictionary",
        "columns": [
            "molregno", "pref_name", "chembl_id", "max_phase", "therapeutic_flag",
            "dosed_ingredient", "structure_type", "molecule_type", "first_approval",
            "oral", "parenteral", "topical", "black_box_warning", "natural_product",
            "first_in_class", "chirality", "prodrug", "inorganic_flag", "usan_year",
            "availability_type", "usan_stem", "polymer_flag", "usan_substem",
            "usan_stem_definition", "withdrawn_flag", "chemical_probe", "orphan",
            "veterinary",
        ],
    },
    "compound_properties": {
